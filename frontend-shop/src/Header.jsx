...
import { UseCart } from "./CartContext"; // Đảm bảo ông đã có file CartContext.js nhé
...
function Header() {
    ...
    // Lắng nghe sự kiện thay đổi user (đăng nhập/đăng xuất)
    useEffect(() => {
        const sync = () => {
            const saved = localStorage.getItem('user');
    ...
    const handleLogout = () => {
        ...
        setUser(null);
        // Phát sự kiện để các component khác biết đã đăng xuất
